...
SYNTHETIC_TOTAL_SIZE = 100
SYNTHETIC_FOR_TRAINING = 50
SYNTHETIC_FOR_EVAL = 50
SYNTH_EXAMPLES_FROM_TRAIN = 150
...
PERCENTAGE_OF_TASKS_THAT_SHOULD_BE_DPO = 0.2
...
# scoring stuff
INSTRUCT_TEXT_TASK_SCORE_WEIGHT = 0.4
...
MAX_BURN_REDUCTION = 0.725
BASE_REGULAR_WEIGHT = 0.175
BASE_TOURNAMENT_WEIGHT = 0.55
...
STANDARD_INSTRUCT_COLUMN = "instruction"
